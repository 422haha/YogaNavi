...
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioDevice.BluetoothHeadset
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioDevice.Earpiece
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioDevice.Speakerphone
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioDevice.WiredHeadset
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioSwitch.State.ACTIVATED
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioSwitch.State.STARTED
import com.ssafy.yoganavi.ui.homeUI.schedule.live.webRtc.audio.AudioSwitch.State.STOPPED
...
class AudioSwitch internal constructor(
  ...
  private fun enumerateDevices(bluetoothHeadsetName: String? = null) {
    ...
    Timber.d("[enumerateDevices] selectedDevice: $selectedDevice")
  ...
  private fun addAvailableAudioDevices(bluetoothHeadsetName: String?) {
    ...
    preferredDeviceList.forEach { audioDevice ->
      Timber.d("[addAvailableAudioDevices] audioDevice: ${audioDevice.simpleName}")
      when (audioDevice) {
        ...
        Speakerphone::class.java -> {
          ...
          Timber.d("[addAvailableAudioDevices] #Speakerphone; hasSpeakerphone: $hasSpeakerphone")
          if (hasSpeakerphone) {
